...
public class WrapperClassEx {
  ...
  public static void main(String[] args) {
    ...
    char c = '4';
    Double d = new Double(3.1234566); // == Double d = 3.1234566;
    System.out.println(Character.toLowerCase('A')); // 대문자 A를 소문자로 변환
    
    if(Character.isDigit(c))//문자c가 숫자르 나타내면 true
    ...
    System.out.println(Integer.parseInt("1", 16)); // 16진수로 펴현된 문자열 "10"을 정수로 출력
    System.out.println(Integer.toBinaryString(28));// 28의 2진수로 표현을 나타내는 문자열 출력
